...
var vm  = new Vue({
    ...
    methods:{
        ...
        deleteFinanceConfirm:function () {
            hide1();
            this.$http.delete("http://106.15.199.21:8080/account/Finance",{
        ...
        deleteStoreConfirm:function () {
            hide2();
            this.$http.delete("http://106.15.199.21:8080/account/store",{
                  body:this.deleteName,
                headers:{
                    username:encodeURI(this.username)
                }
    ...
    mounted(){
        ...
        if(this.username == ""){
            ...
            this.$http.get("http://106.15.199.21:8080/account/finance").then(function (response) {
            ...
            this.$http.get("http://106.15.199.21:8080/account/store").then(function (response) {
                if(response.data.errorCode == 0){
